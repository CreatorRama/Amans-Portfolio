        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative order-1 md:order-2 flex justify-center mb-8 md:mb-0">
            ...
            <div className="relative z-10">
              <div className="w-64 h-64 md:w-80 md:h-80 overflow-hidden rounded-full bg-gradient-to-br from-indigo-500 to-violet-500 p-1 shadow-lg">
              ...
              {/* Fixed position for the "Available for work" badge with improved styling */}
              <div className="absolute -right-4 top-2/3 bg-white shadow-lg rounded-lg px-3 py-2 flex items-center gap-2 backdrop-blur-sm bg-opacity-90 border border-gray-100">
