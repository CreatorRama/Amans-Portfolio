...
const Footer = () => {
  ...
  return (
    <>
      <footer className="bg-gray-900 text-white relative">
        <div className="max-w-6xl mx-auto px-4 py-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* About Section */}
            <div>
              <h3 className="text-xl font-bold mb-4">Aman Pandey</h3>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li className="flex items-center">
                  <a href="mailto:ap410485@gmail.com" className="text-gray-400 hover:text-white transition-colors duration-300">
                  <svg className="h-5 w-5 mr-2 inline text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <li className="flex items-center">
                  ...
                  <span className="text-gray-400">U.P.,Jaunpur,Bharat</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © {currentYear} Aman Pandey. All rights reserved.
            </p>
            <div className="mt-4 md:mt-0">
              <a href="#" className="text-sm text-gray-400 hover:text-white mr-4 transition-colors duration-300">Privacy Policy</a>
      ...
      {/* Chatbot Component - Rendered outside footer but positioned relative to it */}
      {isChatOpen && (
